...
locals {
  ...
  network_admins_group                          = data.terraform_remote_state.bootstrap.outputs.network_admins_group
  gcp_analytics_members                         = data.terraform_remote_state.bootstrap.outputs.gcp_analytics_members
  gcp_data_members                              = data.terraform_remote_state.bootstrap.outputs.gcp_data_members
  ...
  bucket_prefix                                 = data.terraform_remote_state.bootstrap.outputs.common_config.bucket_prefix
