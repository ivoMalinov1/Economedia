...
module "env_data_prod" {
  source = "../../modules/base_env_data_prod"
...
module "env_analytics_prod" {
  source = "../../modules/base_env_analytics_prod"
...
module "project-analytics-iam-group-bindings" {
  ...
  projects = [module.env_analytics_prod.base_shared_vpc_project]
...
module "project-data-iam-group-bindings" {
  source   = "terraform-google-modules/iam/google//modules/projects_iam"
  projects = [module.env_data_prod.base_shared_vpc_project]
