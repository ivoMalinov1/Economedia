...
module "env_data_test" {
  source = "../../modules/base_env_data_test"
...
module "env_analytics_test" {
  source = "../../modules/base_env_analytics_test"
...
module "project-analytics-iam-group-bindings" {
  ...
  projects = [module.env_analytics_test.base_shared_vpc_project]
...
module "project-data-iam-group-bindings" {
  source   = "terraform-google-modules/iam/google//modules/projects_iam"
  projects = [module.env_data_test.base_shared_vpc_project]
